...
with open('results/Fig1_completion.json', 'r') as f:
    completion_data = json.load(f)
with open('results/Fig1_recovery.json', 'r') as f:
...
styles = {
    # BMF - neutral gray
    'BMF': {'color': '#000000', 'linestyle': '-', 'marker': 'o'},  # Black, solid
    
    # Stage I methods - blue
    'Stage I (no E-optimal)': {'color': '#0072B2', 'linestyle': '--', 'marker': 's'},  # Blue, solid
    'Stage I (with E-optimal)': {'color': '#0072B2', 'linestyle': '-', 'marker': '^'},  # Blue, dashed
    
    # Stage I+II without GL - orange
    'Stage I+II (no E, no GL)': {'color': '#E69F00', 'linestyle': '--', 'marker': 'D'},  # Orange, solid
    'Stage I+II (with E, no GL)': {'color': '#E69F00', 'linestyle': '-', 'marker': 'v'},  # Orange, dashed
    
    # Stage I+II with GL - green
    'Stage I+II (no E, with GL)': {'color': '#009E73', 'linestyle': '--', 'marker': '<'},  # Green, solid
    'Stage I+II (with E, with GL)': {'color': '#009E73', 'linestyle': '-', 'marker': '>'}  # Green, dashed
}
...
# completion_results1 = plot_data(ax1, completion_data, completion_Ns, 'Matrix Completion (N=10000-50000)', 
                            #   specific_Ns=[10000, 20000, 30000, 40000, 50000])
...
recovery_results1 = plot_data(ax2, recovery_data, recovery_Ns, 'Matrix Recovery', 
                            specific_Ns=[10000, 20000, 30000, 40000, 50000])
# recovery_results1 = plot_data(ax2, recovery_data, recovery_Ns, 'Matrix Recovery (N=10000-50000)', 
#                             specific_Ns=[10000, 20000, 30000, 40000, 50000])
...
fig.legend(handles, labels, loc='upper center', bbox_to_anchor=(0.5, 1.05), 
          ncol=7, frameon=True, fontsize=42)
...
plt.savefig('results/fig1.pdf', dpi=600, bbox_inches='tight')
plt.close()
...
with open('results/fig1_results.json', 'w') as f:
