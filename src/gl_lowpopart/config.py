...
DEFAULT_C_LAMBDA = 2
DEFAULT_FIG3_N_TOTAL = 50000
DEFAULT_FIG3_N1_VALUES = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000, 20000, 30000, 40000, 50000]
# DEFAULT_FIG3_N_TOTAL = 100000
# DEFAULT_FIG3_N1_VALUES = [2000, 4000, 6000, 8000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000]

DEFAULT_PARAMS = {
    "K": 50,
    "delta": 0.001,
    "Ns": [200, 400, 600, 800, 1000, 2000, 4000, 6000, 8000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 200000, 300000, 400000, 500000],
    # , 600000, 700000, 800000, 900000, 1000000
    "c_lambda": DEFAULT_C_LAMBDA,
    "Rmax": 1 / 4,
    "d1": 3,
    "d2": 3,
    "r": 1,
